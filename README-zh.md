...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 Redmine 复杂的安装及配置。
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| redmine-server | 9007 | 浏览器访问 Redmine | Y |
...
如果需要企业级支持，请订阅我们提供的 [Redmine 企业级支持版](https://apps.websoft9.com/redmine) 
